...
namespace BookShare.Areas.Identity.Pages.Account {
    public class RegisterModel : PageModel {
        ...
        public class InputModel {
            ...
            [StringLength(50, ErrorMessage = "Nazwa użytkownika nie może być dłuższa niż 50 znaków i krótsza niż 3 znaki.", MinimumLength = 3)]
